...
public class HeadListViewCompat extends ListViewCompat {
    private static final String TAG = HeadListViewCompat.class.getSimpleName();
    ...
    public HeadListViewCompat(Context context) {
        super(context);
    }

    public HeadListViewCompat(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public HeadListViewCompat(Context context, AttributeSet attrs, int defStyle) {
