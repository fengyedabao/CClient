...
public class GLProgram {
    ...
    public void buildTextures(Buffer y, Buffer u, Buffer v, int width, int height) {
        ...
        if (videoSizeChanged) {
            ...
            Log.d("GLProgram", "buildTextures videoSizeChanged: w=" + _video_width + " h=" + _video_height);
        }
        ...
        if (_ytid < 0 || videoSizeChanged) {
            ...
            _ytid = textures[0];
            Log.d("GLProgram", "glGenTextures Y = " + _ytid);
        }
        ...
        if (_utid < 0 || videoSizeChanged) {
            ...
            checkGlError("glGenTextures");
            _utid = textures[0];
            Log.d("GLProgram", "glGenTextures U = " + _utid);
        }
        ...
        if (_vtid < 0 || videoSizeChanged) {
            ...
            checkGlError("glGenTextures");
            _vtid = textures[0];
            Log.d("GLProgram", "glGenTextures V = " + _vtid);
        }
    ...
    public int createProgram(String vertexSource, String fragmentSource) {
        ...
        // just check
        Log.d("GLProgram", "vertexShader = " + vertexShader);
        Log.d("GLProgram", "pixelShader = " + pixelShader);
        ...
        if (program != 0) {
            ...
            if (linkStatus[0] != GLES20.GL_TRUE) {
                Log.e("GLProgram", "Could not link program: ", null);
                Log.e("GLProgram", GLES20.glGetProgramInfoLog(program), null);
    ...
    private int loadShader(int shaderType, String source) {
        ...
        if (shader != 0) {
            ...
            if (compiled[0] == 0) {
                Log.e("GLProgram", "Could not compile shader " + shaderType + ":", null);
                Log.e("GLProgram", GLES20.glGetShaderInfoLog(shader), null);
    ...
    private void checkGlError(String op) {
        ...
        while ((error = GLES20.glGetError()) != GLES20.GL_NO_ERROR) {
            Log.e("GLProgram", "***** " + op + ": glError " + error, null);
