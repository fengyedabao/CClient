 ...
 */
public class CubePropertyNetAdapter extends CommonAdapter<CubeTitleTextItem> {

    public CubePropertyNetAdapter(Context context, List<CubeTitleTextItem> mDatas, int itemLayoutId) {
    ...
    public void convert(ViewHolder helper, CubeTitleTextItem item) {
        ...
        EditText textViewCubeDis = helper.getView(R.id.tv_cube_description);
