 ...
 */
public class CubeSearchCityListAdapter extends CommonAdapter<CubeTitleTextItem> {

    public CubeSearchCityListAdapter(Context context, List<CubeTitleTextItem> mDatas, int itemLayoutId) {
