...
public class SelectRoomIconAdapter extends BaseAdapter {
    LayoutInflater mInflater;
    List<ItemBean> mDataList;
    int mSelectedPosition = 0;

    public SelectRoomIconAdapter(Context context, List<ItemBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ItemHolder holder;
        if (null == convertView) {
            convertView = mInflater.inflate(R.layout.grid_select_room_icon, null);
